# An example task, and what makes it examinable
...
| | |
|---|---|
| **[`TASK.md`](TASK.md)** | What to build. The examiner reads it as the brief you were given. |
...
the exam server instead, in a **pack** named by the `assignment:` line. The
pack wins field by field, so editing this file changes nothing about the viva
you sit — it only stops it finding the right brief.

[viva-example-pack][pack] is that other half, and it exercises every field the
